	...
	if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
	...
	$sql= "SELECT * FROM  stock_details WHERE sku LIKE '%".$_POST['searchtxt']."%' OR stock_name LIKE '%".$_POST['searchtxt']."%' OR stock_id LIKE '%".$_POST['searchtxt']."%' OR supplier_id LIKE '%".$_POST['searchtxt']."%' OR date LIKE '%".$_POST['searchtxt']."%'  LIMIT $start, $limit";
...
while($row = mysql_fetch_array($result)) 
{
 ?> 
   ...
   <td> <?php $quantity = $db->queryUniqueValue("SELECT quantity FROM stock_avail WHERE sku='".$row['sku']."'"); echo $quantity; ?></td>

<td> <?php echo "<img width='100' height='100' src='".$row['images']."'"; ?></td>
