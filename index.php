...
<?php include_once("analyticstracking.php") ?>
	...
	<div id="header">
		...
		<div class="page-full-width cf">
			...
			<a href="" id="company-branding" class="fr"  target="blank"><img src="<?php if(isset($_SESSION['logo'])) { echo "upload/".$_SESSION['logo'];}else{ echo "upload/aac.png"; } ?>" alt="AAC" /></a>
			
		</div> <!-- end full-width -->	

	</div> <!-- end header -->
	
        <h1 style="margin-left: 600px; font-family: Georgia;     font-weight: bold; font-size:20px; color: #0060BF">AA COLLECTIONS</a></h1>
