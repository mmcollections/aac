		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				<li><a href="dashboard.php" class="dashboard-tab">Dashboard</a></li>
					<li><a href="view_customers.php" class="active-tab customers-tab">View Customers</a></li>
				</ul> <!-- end tabs -->
                   ...
                   <input name="id" type="hidden" value="<?php echo $_GET['sid']; ?>">  
                    ...
                    <tr>
					 ...
					 &nbsp;
                      ...
                      <td>
                        <input  class="button round blue image-right ic-add text-upper" type="submit" name="Submit" value="Save"></td>
