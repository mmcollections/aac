...
while($row = mysql_fetch_array($result)) 
{
 ?> 
   ...
   <td><a href="update_out_standing.php?sid=<?php echo $row['stock_id'];?>&table=stock_entries&return=view_out_standing.php"	class="table-actions-button ">Pay Now</a></td>
...
<table>
 <tr>
       ...
       <td align="center"><div style="margin-left:20px;"><?php echo $pagination; ?></div></td>
		...
		<div id="footer">
		<p>Any Queries email to <a href="mailto:sridhar.posnic@gmail.com?subject=Stock%20Management%
20System">sridhar.posnic@gmail.com</a>.</p>
