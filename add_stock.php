		...
		$("#form1").validate({
			...
			messages: {
				...
				sku: {
					...
					minlength: "SKU must consist of at least 3 characters"
				}
			}
		});
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					$gump->filter_rules(array(
						...
						'sku'     => 'trim|sanitize_string|mysql_escape',
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
			...
			if($db->query("insert into stock_details(stock_id,stock_name,stock_quatity,supplier_id,company_price,selling_price,category,sku,images) values('$stockid','$name',0,'$supplier',$cost,$sell,'$category','$sku','$image_path')"))
			{ 
				$db->query("insert into stock_avail(name,quantity,sku) values('$name',0,'$sku')");
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
				...
				<form name="form1" method="post" id="form1" action="" enctype="multipart/form-data">
                  ...
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                  	<tr>
                  	<td><span class="man">*</span>SKU:</td>
                  	<td><input name="sku" type="text" id="sku" maxlength="200"  class="round default-width-input" value="<?php echo $sku; ?>" /></td>

			<td><span class="man">*</span>Image:</td>
