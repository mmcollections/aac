	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="add_supplier.php" class="dashboard-tab">Add Supplier</a></li>
...
while($row = mysql_fetch_array($result)) 
{
 ?> 
   ...
   <td> <?php echo $row['supplier_contact2']; ?></td>
    <td>	
		<a href="update_supplier.php?sid=<?php echo $row['id'];?>&table=supplier_details&return=view_supplier.php"	class="table-actions-button ic-table-edit">	</a>
