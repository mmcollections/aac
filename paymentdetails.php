...
<body>
	...
	<div id="header-with-tabs">
		<div class="page-full-width cf">
                ...
                <li><a href="purchase_payments.php" class="dashboard-tab">Purchase Payment </a></li>
		...
		<div class="content-module-heading cf">
						<h3 class="fl">Payment Paid Details</h3>
		...
		<div align="center" class="mytable_row">
			...
			<p>Enter Invoice Number to Delete the Row:<input class="round" type="text" name="bno" placeholder="Enter Bill.No" style="margin-left:10px;" />
			...
			<table border=1>
				...
				<?php
				$sql1 = "select * from purchase_payments order by newdate DESC";
