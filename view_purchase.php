	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="add_purchase.php" class="active-tab purchase-tab"><u>Add Purchase</u></a></li>
	...
	<div id="content">
		...
		<div class="content-module-main cf" >
			...
			<div align="center" class="mytable_row">
				...
				Enter Invoice Number to Check Last Entered Details:<input class="round" name="searchtxt" type="text"  placeholder="Search" style="margin-left:10px;" > 
...
?> 				
				...
				<tr>
					...
					<td style="color:blue"> <?php echo $row1['suppaddr']; ?></td>
