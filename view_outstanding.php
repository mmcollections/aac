...
<body>
	...
	<div id="content">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">View Purchase Outstandings</h3>
		...
		<div class="content-module-main cf" >
			...
			<div align="center" class="mytable_row">
				...
				Enter Invoice No to Check Outstandings:<input class="round" name="searchtxt" type="text"  placeholder="Search" style="margin-left:10px;" > 
...
<div class="">
	<table border=1>
	<tr><td>Purchase <?php echo $srch;?> Amount:</td><td><?php $pqty = $db->queryUniqueValue("SELECT grandamt FROM pur_total WHERE invoiceno='$srch'"); echo $pqty; ?></td></tr>
	<tr><td>TOTAL <?php echo $srch;?> Amnt Paid:</td><td><?php $sqty = $db->queryUniqueValue("SELECT sum(newpayment) FROM purchase_payments WHERE invoiceno='$srch'"); echo $sqty; ?></td></tr>
	<tr><td>BALANCE <?php echo $srch;?> Amount:</td><td>(<?php $bqty=$pqty-$sqty;  echo $bqty; ?>)</td></tr>
	</table>
</div>
</body>
</html>
