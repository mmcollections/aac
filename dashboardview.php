...
<body>
	...
	<div id="content">
							...
							<ul id="tabs" class="temporary-button-showcase">
								...
								<li><a href="view_customers.php" class=" customers-tab">View Customers</a></li>
								<li><a href="view_purchase.php" class="purchase-tab">View Purchase</a></li>
								<li><a href="view_supplier.php" class=" supplier-tab">View Supplier</a></li>
								<li><a href="dashboardview.php" class="report-tab">View All</a></li>
