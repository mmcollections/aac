...
<body>
	...
	<div id="header-with-tabs">
		<div class="page-full-width cf">
                ...
                <li><a href="s_paymentdetails.php" class="dashboard-tab">Sales Payment Details</a></li>
	...
	<!-- MAIN CONTENT -->
		<div class="content-module-heading cf">
				...
				if(isset($_POST['Submit'])){
					...
					$cusname=mysql_real_escape_string($_POST['cusname']);
					$newpayment=mysql_real_escape_string($_POST['new_payment']);
					$mop=mysql_real_escape_string($_POST['mop']);
					$tno=mysql_real_escape_string($_POST['tno']);
					$pay_date=$_POST['date'];
					
					$db->query("INSERT INTO sales_payments(invoiceno,cusname,newpayment,mop,transno,newdate) values('$invoiceno','$cusname',$newpayment,'$mop','$tno','$pay_date')");
				
				$msg="Added successfully Ref: ". $_POST['invoiceno']."" ;
				header("Location: s_paymentdetails.php?msg=$msg");
				}				
				?>
            ...
            <tr>
			<?php
					  $max = $db->maxOfAll("id","sales_payments");
					  $max=$max+1;
					  $autoid="SP".$max."";
					  ?>
				<td align="right">Invoice No:</td>
				
				<td><input name="invoiceno" type="text"  id="invoiceno" maxlength="200" placeholder="Enter Inovice No" class="round default-width-input" value="<?php echo $autoid; ?>"/>
				</td>
			</tr>
            <tr>
				<td align="right">Customer Name:</td>
				<td><input name="cusname" type="text" id="customer" maxlength="200" class="round default-width-input" placeholder="Enter Customer Name"/></td>
            </tr>
			<tr>
